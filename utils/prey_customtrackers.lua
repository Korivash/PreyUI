...
-- Will be set during initialization when PREYCore is available
local PREYCore
...
local function RebuildActiveSet(bar)
    ...
    -- print("|cFF00FF00[PREY Debug]|r RebuildActiveSet: " .. #bar.activeIcons .. " of " .. #(bar.icons or {}) .. " icons active")
end
...
_G.PreyUI_RefreshCustomTrackers = function()
    -- Use local CustomTrackers directly since PREYCore might not be set yet
...
initFrame:SetScript("OnEvent", function(self, event, ...)
    ...
    if event == "PLAYER_ENTERING_WORLD" then
        -- Set PREYCore reference now that it's available
