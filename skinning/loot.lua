--- PreyUI Loot & Roll Frames
--- Custom loot window and roll frames with PREY styling
...
-- Helper to get theme colors from PREY skin system
...
local EDIT_BORDER_COLOR = { 0.820, 0.180, 0.220, 1 }  -- Blue to match PREY style
local EDIT_BORDER_SIZE = 2

-- Create border highlight around a frame (matching PREY player frame style)
...
-- Initialize when PREYCore is enabled
local initFrame = CreateFrame("Frame")
initFrame:RegisterEvent("PLAYER_LOGIN")
initFrame:SetScript("OnEvent", function(self, event)
    -- Defer initialization to let PREYCore load first
