...
---------------------------------------------------------------------------
-- Main skinning setup
-- Note: OnShow hook is handled by prey_character.lua which calls SetExtended()
...
local function SetupInspectFrameSkinning()
    ...
    -- Create initial background (will be positioned by prey_character.lua via SetExtended)
    CreateOrUpdateBackground()
