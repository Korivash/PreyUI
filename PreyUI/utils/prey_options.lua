...
local function BuildImportExportTab(tabContent)
    ...
    GUI:SetSearchContext({tabIndex = 13, tabName = "PREY Import/Export", subTabIndex = 1, subTabName = "Import/Export"})
...
local function BuildPreyStringsTab(tabContent)
    ...
    GUI:SetSearchContext({tabIndex = 13, tabName = "PREY Import/Export", subTabIndex = 2, subTabName = "Prey's Strings"})
