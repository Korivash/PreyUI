...
function PREY_Castbar:GetEmpoweredLevel()
    ...
    if not playerCastbar then
        playerCastbar = _G.PreyUI_Castbars and _G.PreyUI_Castbars["player"]
    end
...
function PREY_Castbar:SetupPlayerCastbar(castbar, unit, unitKey, castSettings)
    self:SetupCastbar(castbar, unit, unitKey, castSettings)
end
...
_G.PreyUI_ShowCastbarPreview = function(unitKey)
    local settings = GetUnitSettings(unitKey)
...
_G.PreyUI_HideCastbarPreview = function(unitKey)
    local settings = GetUnitSettings(unitKey)
    if not settings or not settings.castbar then
        return
    end
...
function PREY_Castbar:RefreshCastbar(castbar, unitKey, castSettings, unitFrame)
    ...
    if newCastbar then
        ...
        if PREY_UF and PREY_UF.castbars then
            PREY_UF.castbars[unitKey] = newCastbar
        end
    end
end
...
function PREY_Castbar:RefreshBossCastbar(castbar, bossKey, castSettings, unitFrame)
    ...
    if newCastbar then
        local PREY_UF = self.unitFramesModule
        if PREY_UF and PREY_UF.castbars then
            PREY_UF.castbars[bossKey] = newCastbar
        end
    end
end

_G.PreyUI_RefreshCastbar = function(unitKey)
    local PREY_UF = PREY_Castbar.unitFramesModule
...
_G.PreyUI_Castbars = PREY_Castbar.castbars
